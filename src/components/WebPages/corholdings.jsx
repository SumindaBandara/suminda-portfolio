...
const PAGE_DATA = {
  company: {
    name: "C.O.R Holdings",
    full_name: "C.O.R Holdings Pvt Ltd",
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className={`h-10 w-10 rounded-full flex items-center justify-center ${isScrolled ? 'bg-emerald-900' : 'bg-white'}`}>
                <span className={`font-bold text-xl ${isScrolled ? 'text-white' : 'text-emerald-900'}`}>C</span>
            </div>
            <div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
                <div className="rounded-[40px] overflow-hidden shadow-2xl border-4 border-white">
                    <img 
                        src="https://lh3.googleusercontent.com/p/AF1QipPYZ-wZJDfovoIUY9EMvKH6naVbuKpTg-UKyoJb=s1360-w1360-h1020-rw" 
                        alt="C.O.R Holdings Owner" 
            ...
            <div>
                ...
                <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 leading-tight">
                    Driven by Corporate <span className="text-emerald-800">Standards.</span>
                </h2>
                <p className="text-slate-600 text-lg mb-6 leading-relaxed">
                    Founded in {PAGE_DATA.company.founded} as a construction company, <span className="font-bold text-emerald-900">C.O.R Holdings</span> evolved with a singular vision: to bring professional corporate practices to the automobile industry in Sri Lanka.
                </p>
                <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    We don't just sell cars; we deliver premium vehicle solutions. From the moment you step into our Malabe showroom to the moment you drive away, you experience transparency, integrity, and the highest quality service.
                </p>
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Malabe, Sri Lanka</p>
                            </div>
                        </div>
                    </div>
                </div>
